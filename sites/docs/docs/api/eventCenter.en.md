...
| node:touchstart  | Start touch the node                                                                                  | data, e           |
| node:touchend    | End touch the node                                                                                  | data, e           |
| node:touchmove   | Move touch the node                                                                                  | data, e           |
...
| blank:touchstart  | Start touch the canvas                  | e            |
| blank:touchmove   | Move touch the canvse                   | e            |
| blank:touchend    | End touch the canvas                    | e            |
