import { Button, Flex, Form, Radio, Divider, Space } from 'antd';
import React, { useState, useEffect, useRef } from 'react';

const { SelectionSelect } = Extension;
 ...
 */
const SelectionSelectExample: React.FC = () => {
...
root.render(<SelectionSelectExample></SelectionSelectExample>);
