...
- features
  - 增加自定义连线连接时选择哪个锚点。[#791](https://github.com/didi/LogicFlow/issues/791) 
  - 小地图插件功能完善。[#829](https://github.com/didi/LogicFlow/issues/829)
...
- features
  - 多选按键支持ctrl作为组合键。[#836](https://github.com/didi/LogicFlow/issues/836)
  - `node:dnd-add`事件抛出原生event。[#860](https://github.com/didi/LogicFlow/issues/860)

- bugfix
  - 修复了getArrow方法ts类型设置问题。[#851](https://github.com/didi/LogicFlow/issues/851)
  - 修复连线起点箭头位置略微向里偏移问题。
  - 修复多次复制出现连线起始节点Id错误的问题。[#866](https://github.com/didi/LogicFlow/issues/866)
  - 修复isSilentMode切换无法恢复配置的history相关功能。[848](https://github.com/didi/LogicFlow/issues/848)
...
- features
  ...
  - group节点默认导出的数据增加`isGroup:true`属性。
- bugfix
  ...
  - 修复开启边动画在某些项目中动画效果错误的问题。[#840](https://github.com/didi/LogicFlow/issues/840)
  - 修复了updateEditConfig更改isSilentMode状态问题。[#826](https://github.com/didi/LogicFlow/issues/826)
...
- features
  ...
  - `getAnchorLineStyle`增加参数anchorInfo, 用于开发者自定义不同的锚点使用不同样式的连接线。[#766](https://github.com/didi/LogicFlow/issues/766)
 
- bugfix
  - 修复在edge:add 事件中通过changeEdgeId修改Id后，不出现箭头的问题。[#788](https://github.com/didi/LogicFlow/issues/788)
...
- features
  ...
  - 增加单独删除节点或边的某个属性API: `lf.deleteProperty(id, key)`和`model.deleteProperty(key)`。
