...
import { createUuid } from '../../../../core/src/util';
...
class NodeSelectionModel extends PolygonNodeModel {
  ...
  setAttributes() {
    ...
    if (this.properties.active_color) this.activeColor = this.properties.active_color;
    if (this.properties.active_color) this.stroke = this.properties.active_color;
    this.zIndex = 0;
