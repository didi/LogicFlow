...
describe('test curved edge ', () => {
  test('path calculation', () => {
    ...
    const path2 =
      'M510 250L 535 250 Q 540 250 540 245L 540 180 Q 540 175 535 175L 495 175 Q 490 175 490 170L 490 105 Q 490 100 495 100L 520 100'
    expect(
      getCurvedEdgePath(
    ...
    const path3 =
      'M690 120L 715 120 Q 720 120 720 115L 720 55 Q 720 50 715 50L 565 50 Q 560 50 560 55L 560 255 Q 560 260 565 260L 690 260'
    expect(
      getCurvedEdgePath(
    ...
    const path4 =
      'M690 180L 690 205 Q 690 210 685 210L 665 210 Q 660 210 660 205L 660 195 Q 660 190 655 190L 635 190 Q 630 190 630 195L 630 220'
    expect(
      getCurvedEdgePath(
