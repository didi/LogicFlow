...
import {
  ServiceTaskModelContractor,
  ServiceTaskViewContractor,
} from '../../../type.d';

export const getUserTaskModel = (
  RectNodeModel: ServiceTaskModelContractor,
): ServiceTaskModelContractor => {
...
export const getUserTaskView = (
  RectNode: ServiceTaskViewContractor, h,
): ServiceTaskViewContractor => {
